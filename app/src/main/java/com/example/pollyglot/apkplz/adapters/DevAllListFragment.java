...
public abstract class DevAllListFragment extends Fragment {

    private static final String TAG = "DevAllListFragment";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecycler = (RecyclerView) view.findViewById(R.id.dev_all_list);
